{
  ...
  security = {
    ...
    # Enhanced processor security for rollback protection
    # allowSimultaneousMultithreading = false; # Disabled for performance reasons
  };
  ...
  services = {
    ...
    # Firmware update daemon with security focus
    fwupd.enable = true;
  };

  # Hardware security settings
  hardware = {
    # Enable firmware security updates
    enableRedistributableFirmware = true;

    # CPU microcode updates for enhanced security and processor rollback protection
    cpu.amd.updateMicrocode = true;
  };

  # Additional systemd hardening
  systemd = {
    # Coredump settings for security
  ...
  # Add cryptsetup to system packages for fwupdmgr swap encryption detection
